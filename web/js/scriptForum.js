...
function buscaimg(livros){
	...
	$.ajax(settings).done(function (response) {
		...
		$.ajax(settings).done(function (response) { 
			$("#listaforuns").append("<div class='c-forum t-forum'><a class='c-forum-body t-forum-body' href=''>\
				<span class='c-forum-media t-forum-media'><svg class='o-icon c-forum-media-icon-read t-forum-media-icon-read'><use xlink:href='#forum'></use></svg></span>\
				...
				<p class='c-forum-text t-forum-text'>"+response.items[0].volumeInfo.title+"</p>\
				<p class='c-forum-text t-forum-text'>"+response.items[0].volumeInfo.authors+"</p>\
				</div></a>\
